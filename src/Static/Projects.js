...
const PROJECTS = [
  {
    ...
    description:
      "This game uses vanilla Javascript to bring basic HTML and CSS to life with a fun economics game. Indy is a dog who runs a taco truck for dogs! But he needs help keeping his truck in business. The player needs to sell more tacos and keep their customers happy by buying ingredients and upgrading the tacos as more revenue is made. This simple game demonstrates DOM manipulation and the power of pure Javascript. Creating this game with gifs and images was a lot of fun. I hope you have fun playing it!",
  ...
  },
  {
    ...
    description:
      "This site is built with the MERN stack. The backend is a RESTful API built with Node and Express that accesses a MongoDB database. The client side is built with React and functions as a single-page application. This app uses a user login system built with JWT tokens. People use this app to help build healthy habits that stick over time with daily tracking and graphical data representations to display progress. Users can add a new habit and track each time within a day they accomplish that goal!",
